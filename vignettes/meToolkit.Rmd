...
At anytime a csv of all the subject ids that have one or more of the currently selected phenotypes can be downloaded using the "Selected subjects" button at the top right of the app. If a code or patterns of codes are selected in the [upset plot](#comorbidity-upset-plot), nodes that have the selected pattern will be noted as `highlighted` in the exported id list. 
