...
#' @param highlighted_codes Reactive object containing list with `type`: (`{'pattern', 'code'}`) and `codes`: array of code names that comprise connection pattern to highlight in patients.
