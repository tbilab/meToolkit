#' Calculate a risk ratio confidence interval given a pattern and snp count
#'
...
#' @param CI_size Size of CI in proportion (default 0.95 = 95% interval)
#'
#' @return A list with three entries: PE or RR point estimate, lower and upper for RR lower and upper bounds given interval size.
#' @export
#'
#' @examples
#' calc_RR_CI(
