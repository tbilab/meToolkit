...
#' Takes as input the three basic components of an ME app and returns a list containing the ui and server parts of an entire app. This makes it easy to deploy a custom app with a few lines of code.
...
#'
#' @return A list containing elements: `ui` for the shiny app ui function, and `server` for the server component of app.
#' @export
#'
#' @examples
...
build_me_app <- function(snp_name, results_data, individual_data, max_allowed_codes = 45){
